...
GlRenderer.prototype.renderTriangles = function(iw, ih) {
    ...
    for(var i = triangles.length - 1; i > 2; i -= 3) {
        ...
        var pa = [vertices[triangles[i]][0] * size.w + size.ow,
                vertices[triangles[i]][1] * size.h + size.oh];
        var pb = [vertices[triangles[i - 1]][0] * size.w + size.ow,
                vertices[triangles[i - 1]][1] * size.h + size.oh];
        var pc = [vertices[triangles[i - 2]][0] * size.w + size.ow,
                vertices[triangles[i - 2]][1] * size.h + size.oh];
